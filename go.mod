module github.com/NubeIO/module-migration
...
require (
	...
	github.com/NubeIO/nubeio-rubix-lib-modbus-go v0.0.8 // indirect
	github.com/NubeIO/nubeio-rubix-lib-models-go v1.14.0 // indirect
